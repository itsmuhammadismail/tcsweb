    ...
    <div>
      ...
      <Layout>
        ...
        <div className="flex flex-col justify-center  gap-8 max-w-[50rem] mx-auto  p-[3rem]">
          ...
          <p>
            Secure online payment options via established international payment
            gateways are available (Including PayPal, Google Pay, Apple Pay,
            Installment Plans and Credit/Debit Cards).
          </p>
